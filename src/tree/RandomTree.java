...
//        throw new UnsupportedOperationException();
    ...
    private Node<T> union(Node<T> nodeLeft, Node<T> nodeRight) { // придумать как слить ноды в один
        ...
        int sumOfLeft = countNodes(nodeLeft); //todo  метод countNodes возвращать количество узлов в поддереве +
...
//        throw new UnsupportedOperationException();
    ...
    public void printTree() { // работает
        int curDepth = 0; // уровни/divisor // TODO: 10.11.2023 убрать нахуй из класса, сделать локальной в методе +
        int[] maxDepth = new int[]{0}; // TODO: 10.11.2023 убрать нахуй из класса, сделать локальной в методе +
        findDepth(curDepth, root, maxDepth);
        int level = maxDepth[0] + 1;
        Queue<Node<T>> nodeQueueParents = new Queue<>((int) Math.pow(2, level)); // TODO: 10.11.2023 убрать нахуй из класса, сделать локальной в методе +
        Queue<Node<T>> nodeQueue = new Queue<>((int) Math.pow(2, level)); // TODO: 10.11.2023 убрать нахуй из класса, сделать локальной в методе +
        nodeQueue.add(root);
